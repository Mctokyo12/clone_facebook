...
const EditPost = ({user , setEditPost , editPost , currentPost}) => {
    ...
    return (
        <div>
            <div id="Publication" class={`fixed overflow-y-auto z-20 top-0   ${ editPost? "":"invisible opacity-0"}   transition-all left-0 w-full h-full dark:bg-dark-main/70   bg-white/70   dark:text-dark-text text-gray-500`}>
                        ...
                        <div class="flex items-center px-4 pb-2 gap-2">
                            <div  class="w-10 aspect-square relative ">
                                <div class=" overflow-hidden rounded-full">
                                    <img src="/images/avt.jpg" alt="" srcset="" class="w-full aspect-square object-cover"/>
                                </div>
                                <span class=" w-3 aspect-square absolute right-0 bottom-0 rounded-full bg-green-500  border-4 border-white"></span>
                            </div>
                            <div>
                                <h4 class="text-lg">{post.firstname}</h4>
                        ...
                        <div class="px-4 relative">
                            ...
                            <form id="EditForm" class="flex flex-col gap-2" onSubmit={(e)=>handleSubmit(e)} >
                                ...
                                {loading ? 
                                    ...
                                    : 
                                    <input type='submit' class={`border-transparent  flex garp-2 items-center ${textInput ? ' bg-blue':'bg-gray-400'}  text-white    w-full  text-xl font-semibold rounded-lg px-2 py-2 `} value={"Enregistre"}/>
                                }
