...
const OldCover = ({setOldCoverVisble , setImageSrc}) => {
    ...
    return (
        <>
            <div id="Cover" className={`fixed overflow-y-auto  z-30 top-0  transition-all left-0 w-full h-full dark:bg-dark-main/85 bg-white/85 dark:text-dark-text text-gray-800`}>

                <div className="max-h-[90%] scrollbar w-full sm:w-[85%] lg:w-[70%] xl:w-[40%] shadow-lg dark:bg-dark-second bg-white overflow-y-scroll  absolute left-1/2  top-[20%]  -translate-x-1/2 -translate-y-[20%]">
